...
__all__ = ["RedefinedLinearRegionItem"]


class RedefinedLinearRegionItem(GraphicsObject):
    """
    ...
    **Signals:**
    ...
    def __init__(
        ...
        """Create a new RedefinedLinearRegionItem.
        ...
        **Arguments:**
        ...
        clipItem        An item whose bounds will be used to limit the region bounds.
                        This is useful when a RedefinedLinearRegionItem is added on top of an
    ...
    def setBounds(self, bounds):
        ...
        :func:`~pyqtgraph.RedefinedLinearRegionItem.setRegion` to set the position of the region.
